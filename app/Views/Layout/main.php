...
<head>
    ...
    <title> FR - Ordem de Serviço | <?php echo $this->renderSection('title');?> </title>
    ...
    <div class="d-flex align-items-stretch">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled">
                ...
                <li class="<?php echo (url_is('users*') ? 'active' : '')?>"><a href="<?php echo site_url('users');?>">
                        <i class="icon-user"></i>Usuários </a></li>
                <li class="<?php echo (url_is('groups*') ? 'active' : '')?>"><a href="<?php echo site_url('groups');?>">
                        <i class="icon-settings"></i>Grupos & Permissões </a></li>
